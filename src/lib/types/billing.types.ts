...
// ============================================================================
// Client Room Instructions (Feature: 009-staff-portal)
// ============================================================================

export interface ClientRoomInstruction {
  id: string
  client_id: string
  room_type_id: string
  instructions: string
...
export interface ClientRoomInstructionWithRoom extends ClientRoomInstruction {
  room_type: {
    id: string
    name: string
    name_fr: string
...
export interface ClientRoomInstructionInsert {
  client_id: string
  room_type_id: string
  instructions: string
}

export interface ClientRoomInstructionUpdate {
  instructions: string
}
